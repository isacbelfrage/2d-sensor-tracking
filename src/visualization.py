...
def plot_positions(real_positions: list[tuple[float, float]],
                   ...
                   alpha_beta_estimates: list[tuple[float, float]],
                   kalman_estimates: list[tuple[float, float]]) -> None:
    ...
    kalman_x, kalman_y = split_positions(kalman_estimates)
    ...
    plt.plot(kalman_x, kalman_y, label="Kalman-filter estimate")
